        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tr>
                        <th>S.no</th>
                        <th>Xeberin basliqi</th>
                        <th>Xeberin aciqlamasi</th>
                        <th>Xeberin sekili</th>
                        <th>Emeliyyat</th>
                    </tr>
                    </thead>
                    <tbody>
                    ...
                    foreach ($melumat as $melumat):  ?>
                        <tr>
                            ...
                            <td><?php  echo substr( $melumat->blog_desc_az,0,100)?></td>
                            <td><img  src="<?php echo base_url();echo $melumat->blog_image_kicik;?> "style="width: 80px; height: 60px;"></td>
