        ...
        <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?= base_url('back/settingsupdate');  ?>" >
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="mail" disabled class="form-control" value="<?php echo $melumat->email; ?>"  >
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="tarih" disabled class="form-control" value="<?php echo $melumat->date; ?>"  >
                    </div>
                </div>
