...
<div class="box box-info">
    <div class="box-header with-border">
        <h3 style="padding-left: 40px" class="box-title">Oyuncu elave et</h3>
    </div>
    <!-- /.box-header -->
    <style>
        div label{
    ...
    <div style="padding-left: 40px;" class="box-body">
        ...
        <form method="post" id="mesajform" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label>Boy</label>
                <input type="text" name="player_height" required  class="form-control">

            </div>     <div class="form-group">
                <label>Çəki</label>
                <input type="text" name="player_weight" required  class="form-control">

            </div>     <div class="form-group">
                <label>Yaş</label>
                <input type="text" name="player_age" required  class="form-control">

            </div>     <div class="form-group">
                <label>Qollarin sayi</label>
                <input type="text" name="goal" required  class="form-control">

            </div>     <div class="form-group">
                    <label>Asist</label>
                <input type="text" name="asiste" required  class="form-control">
                ...
                <div class="col-sm-10">
                    <select name="player_task">
                       <?php $player=player_task(); foreach ($player as $player):  ?>
                        <option required value="<?= $player->id;  ?>"><?=  $player->player_task_name_az ?></option>
                          <?php  endforeach;   ?>
...
<script>
    $(document).ready(function () {
        ...
        $('#mesajform').on('submit',function (e) {
            e.preventDefault();
            $.ajax({
                url:'<?php echo base_url(); ?>back/playersadded',
                method:'POST',
