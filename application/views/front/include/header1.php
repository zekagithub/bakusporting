...
<head>
    ...
    <meta name="description" content="<?php echo $melumat->site_description ?>">
    <meta name="author" content="VhStudio" />
                                    ...
                                    <nav class="tg-addnav">
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                ...
                                                <a id="tg-btn-search" href="javascript:void(0)"><i class="fa fa-envelope"></i><?= $melumat->site_mail;?></a>
                                            </li>
