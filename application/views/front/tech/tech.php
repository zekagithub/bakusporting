                        ...
                        <div id="tg-navigation" class="tg-navigation">
                            <div class="tg-colhalf">
                                <ul>
                                    ...
                                    <li <?php if ($this->uri->segment(1)=='technical'){ echo 'class=active';} ?>><a href="#"><?php echo $this->lang->line('club');  ?></a>
                                        <ul class="tg-dropdown-menu">
            ...
            <div class="row">
                <div class="tg-banner-content tg-haslayout">
                    <div class="tg-pagetitle">
                        <h1><?php echo $this->lang->line('tech'); ?></h1>
                    </div>
        ...
        <section class="tg-main-section tg-haslayout">
            <div class="container">
                <div class="tg-section-name">
                    <h2><?php echo $this->lang->line('tech'); ?></h2>
                </div>
                        ...
                        <div class="tg-aboutussection">
                            ...
                            <div class="row">
                                <div class="col-md-6 col-sm-12 col-xs-12">
                                    <figure>
                                        <img src="<?php echo base_url();echo $tech->tech_image?>" style="width: 507px;height: 330px;" alt="<?php  echo $tech->tech_name_az;?>">
                                    </figure>
                                </div>
                                <div class="col-md-6 col-sm-12 col-xs-12">
                                    <div class="tg-contentbox">
                                        <div class="tg-section-heading"><h2><?php echo $tech->tech_name_az; ?>
                                            </h2></div>
                                        <div class="tg-description">
                                            <p>
                                                <?php
                                                if( $this->session->userdata('lang')=='az'){
                                                    echo $tech->tech_desc_az;
                                                }elseif( $this->session->userdata('lang')=='en'){
                                                    echo $tech->tech_desc_en;


                                                }
                                                else{
                                                    echo $tech->tech_desc_ru;
                                                }
                                                ?>
                                            </p>
