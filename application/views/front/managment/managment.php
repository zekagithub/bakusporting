            ...
            <div class="row">
                <div class="tg-banner-content tg-haslayout">
                    <div class="tg-pagetitle">
                        <h1><?php echo  $this->lang->line('menec'); ?></h1>
                    </div>
        ...
        <section class="tg-main-section tg-haslayout">
            <div class="container">
                <div class="tg-section-name">
                    <h2><?php echo  $this->lang->line('menec'); ?></h2>
                </div>
                <div class="col-sm-11 col-xs-11 pull-right">
                    <div class="row">
                        ...
                        <div class="tg-aboutussection">
                            <?php  foreach ($menec as $menec): ?>
                            <div class="row">
                                <div class="col-md-6 col-sm-12 col-xs-12">
                                    <figure >
                                        <img src="<?php echo base_url();echo $menec->managment_image;?>"  alt="<?php echo $menec->managment_title_az;?>">
                                    </figure>
                                </div>
                                <div class="col-md-6 col-sm-12 col-xs-12">
                                    <div class="tg-contentbox">
                                        <div class="tg-section-heading"><h2>
                                                ...
                                                if( $this->session->userdata('lang')=='az'){
                                                    echo $menec->managment_title_az;
                                                }elseif( $this->session->userdata('lang')=='en'){
                                                    echo $menec->managment_title_en;
                                                }
                                                else{
                                                    echo $menec->managment_title_ru;
                                        ...
                                        <div class="tg-description">
                                            <p>
                                                <?php
                                                if( $this->session->userdata('lang')=='az'){
                                                    echo $menec->managment_desc_az;
                                                }elseif( $this->session->userdata('lang')=='en'){
                                                    echo $menec->managment_desc_en;


                                                }
                                                else{
                                                    echo $menec->managment_desc_ru;
